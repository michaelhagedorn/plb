		...
		*/
		...
		function select($dbname='', $encoding='')
		{
			...
			if ( ! $dbname )
			{
                                ...
                                $log->quickAddLog("Datenbank name nicht gesetzt");
			...
			{
                                $log->quickAddLog("Keine aktive Datenbank-Anbindung");
			...
			else
			{
				...
				$log->quickAddLog("Datenbank $dbname gewählt!");
				$return_val = true;
			}
		...
		function query($query)
		{
			...
			if ( $this->use_trace_log )
			{
				$this->trace_log[] = $this->debug(false);
                        ...
                        $log->quickAddLog("MySQL-Query: \"" . $query . "\" -> Results: " .$return_val, "Database");
			return $return_val;
